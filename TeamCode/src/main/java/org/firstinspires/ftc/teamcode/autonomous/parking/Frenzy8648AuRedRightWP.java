...
@Autonomous(name = "8648 Red Right WP", group = "Concept")
//@Disabled
public class Frenzy8648AuRedRightWP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(robot.DRIVE_SPEED, 40.0, 40.0,40.0, 40.0, 5);
        encoderDrive(robot.TURN_SPEED, -15, 15, 15, -15, 9);
