...
import org.firstinspires.ftc.teamcode.minibot.Subsystems.SideServo;

@Autonomous(name="Basic Hassle Mecanum Drive ", group="Auto")
@Disabled
...
public class BasicHassleMecanum extends LinearOpMode {
    /* Declare OpMode members. */

    // When the robot is instatiated from the robot subsystem, it automatically assumes an autonomous opMode.
    public Frenzy8648HardwarePushbot robot  = new Frenzy8648HardwarePushbot();   // Use subsystem robot
    ...
    public void runOpMode() {
        robot.init(hardwareMap, true); // call the init method in the subsystem. THis saves space here
        // Gyro set-up
        ...
        // Encoder rest is handled in the robot init in robot class
    ...
    public void gyroDrive ( double speed,
        ...
        if (opModeIsActive() & drivetime.time() < timeout) {
            ...
            moveCounts = (int)(distance *  Frenzy8648HardwarePushbot.COUNTS_PER_INCH);
